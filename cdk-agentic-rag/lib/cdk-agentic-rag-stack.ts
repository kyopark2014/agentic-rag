...
EOF'`,
      ...
      `runuser -l ec2-user -c 'pip install boto3 langchain_aws langchain langchain_community langchain_experimental'`,
      `runuser -l ec2-user -c 'pip install langgraph opensearch-py PyPDF2 yfinance rizaio plotly_express numpy matplotlib'`,      
